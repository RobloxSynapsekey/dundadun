...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(51, 10, 15),  -- deep navy-tinted black for depth
        MainColor = Color3.fromRGB(11, 89, 13),        -- slightly lighter with blue undertone
        ...
        Red = Color3.fromRGB(255, 65, 90),             -- richer red with a pink hue
